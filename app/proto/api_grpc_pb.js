...
function deserialize_concordium_NodeInfoResponse(buffer_arg) {
  return api_pb.NodeInfoResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_concordium_PeerListResponse(buffer_arg) {
  return api_pb.PeerListResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_concordium_PeerStatsResponse(buffer_arg) {
  return api_pb.PeerStatsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
