...
function deserialize_concordium_BlockHashAndAmount(buffer_arg) {
  return api_pb.BlockHashAndAmount.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_concordium_GetAddressInfoRequest(buffer_arg) {
  return api_pb.GetAddressInfoRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_concordium_GetModuleSourceRequest(buffer_arg) {
  return api_pb.GetModuleSourceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_concordium_GetTransactionStatusInBlockRequest(buffer_arg) {
  return api_pb.GetTransactionStatusInBlockRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_concordium_NetworkChangeRequest(buffer_arg) {
  return api_pb.NetworkChangeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_concordium_PeerConnectRequest(buffer_arg) {
  return api_pb.PeerConnectRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_concordium_SendTransactionRequest(buffer_arg) {
  return api_pb.SendTransactionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
