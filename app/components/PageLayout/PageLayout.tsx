...
import FullWidthContainerSection from './PageContainer/FullWidthContainerElement';
...
PageLayout.FullWidthContainerSection = FullWidthContainerSection;
(PageLayout.FullWidthContainerSection as FC).displayName =
