...
import { instanceOfUpdateInstruction, TransactionHandler, UpdateInstruction, UpdateType } from "../../utils/types";
import { serializeUpdateInstruction } from "../../utils/UpdateSerialization";

export class UpdateInstructionHandler implements TransactionHandler<UpdateInstruction> {
    ...
    signTransaction(ledger: ConcordiumLedgerClient, transaction: UpdateInstruction) {
