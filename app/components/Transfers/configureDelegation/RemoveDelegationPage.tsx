...
const RemoveDelegationPage = ({ onNext }: RemoveDelegationPageProps) => {
    const cooldownUntil = useCalcBakerStakeCooldownUntil();

    return (
        <>
            <p className="flexChildFill">
                This will withdraw the delegated amount of the account. After
                the grace period the full delegated amount will be unlocked for
                disposal.
                {cooldownUntil && (
                    <>
                        <br />
