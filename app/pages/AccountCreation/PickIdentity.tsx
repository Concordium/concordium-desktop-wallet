...
export default function AccountCreationPickIdentity({
    ...
    return (
        <Columns columnScroll variableSize className={styles.columns}>
            <Columns.Column>
                ...
                <div className="flexChildFill flexColumn justifySpaceBetween">
                    <div>
                        <p>
                            ...
                            creating your new account. Besides choosing your
                            identity, you must decide whether to reveal any
                            attributes on the account, and how many.
                        </p>
                        <p>
                            Besides deciding on an identity, you can decide to
                            reveal a number of attributes on your account,
